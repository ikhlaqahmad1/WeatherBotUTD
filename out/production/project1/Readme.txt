...
received in json format and, with the help of a gson library, parsed.

Api used:
    1) www.openweather.org
        Returns weather for any location in the U.S., either by name or zip code. Zip code is the
        preferred method to inquire about the weather to avoid any ambiguity (e.g. Dallas, TX, Dallas, GA).
